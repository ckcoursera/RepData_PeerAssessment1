...
totalmean #Total mean steps is 10766.19
totalmedian <- median(stepsbyday$totalsteps) 
totalmedian #Total median is 10765
...
hist(imputedhist$imputedsteps, main="Imputed total steps taken each day", xlab="Total Steps", ylab="Frequency (days)")
dev.off()
